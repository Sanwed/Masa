...
!function (t, i) {
  ...
  var K, Y = h({}, F, {code: 'EPSG:3857', projection: V, transformation: G(K = .5 / (Math.PI * V.R), .5, -K, .5)}),
  ...
  var Q = document.documentElement.style, tt = 'ActiveXObject' in window, it = tt && !document.addEventListener,
    et = 'msLaunchUri' in navigator && !('documentMode' in document), nt = kt('webkit'), ot = kt('android'),
    st = kt('android 2') || kt('android 3'), rt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
    at = ot && kt('Google') && rt < 537 && !('AudioNode' in window), ht = !!window.opera, ut = !et && kt('chrome'),
    lt = kt('gecko') && !nt && !ht && !tt, ct = !ut && kt('safari'), _t = kt('phantom'), dt = 'OTransition' in Q,
    pt = 0 === navigator.platform.indexOf('Win'), mt = tt && 'transition' in Q,
    ft = 'WebKitCSSMatrix' in window && 'm11' in new window.WebKitCSSMatrix && !st, gt = 'MozPerspective' in Q,
    vt = !window.L_DISABLE_3D && (mt || ft || gt) && !dt && !_t, yt = 'undefined' != typeof orientation || kt('mobile'),
    xt = yt && nt, wt = yt && ft, Pt = !window.PointerEvent && window.MSPointerEvent,
    ...
    Tt = yt && ht, Mt = yt && lt,
    zt = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI), Ct = function () {
      var t = !1;
      try {
      ...
      return t;
    }(), St = !!document.createElement('canvas').getContext, Zt = !(!document.createElementNS || !J('svg').createSVGRect),
    Et = !Zt && function () {
      try {
  ...
  var Bt = {
      ...
      svg: Zt,
      vml: Et,
    }, At = Pt ? 'MSPointerDown' : 'pointerdown', It = Pt ? 'MSPointerMove' : 'pointermove',
    Ot = Pt ? 'MSPointerUp' : 'pointerup', Rt = Pt ? 'MSPointerCancel' : 'pointercancel', Nt = {}, Dt = !1;
  ...
  var Vt = Pt ? 'MSPointerDown' : Lt ? 'pointerdown' : 'touchstart',
    qt = Pt ? 'MSPointerUp' : Lt ? 'pointerup' : 'touchend', Gt = '_leaflet_';
  ...
  function ki(i, t, e, n) {
    ...
    Lt && 0 === t.indexOf('touch') ? jt(i, t, c, o) : bt && 'dblclick' === t && !Zi() ? (r = c, l = !1, (s = i)[Gt + Vt + (a = o)] = d, s[Gt + qt + a] = p, s[Gt + 'dblclick' + a] = r, s.addEventListener(Vt, d, !!Ct && {passive: !1}), s.addEventListener(qt, p, !!Ct && {passive: !1}), s.addEventListener('dblclick', r, !1)) : 'addEventListener' in i ? 'touchstart' === t || 'touchmove' === t || 'wheel' === t || 'mousewheel' === t ? i.addEventListener(Ei[t] || t, c, !!Ct && {passive: !1}) : 'mouseenter' === t || 'mouseleave' === t ? (c = function (t) {
  ...
  function Bi(t, i, e, n) {
    ...
    if (!d) return this;
    Lt && 0 === i.indexOf('touch') ? (c = (u = t)['_leaflet_' + (l = i) + _], 'touchstart' === l ? u.removeEventListener(At, c, !1) : 'touchmove' === l ? u.removeEventListener(It, c, !1) : 'touchend' === l && (u.removeEventListener(Ot, c, !1), u.removeEventListener(Rt, c, !1))) : bt && 'dblclick' === i && !Zi() ? (r = (o = t)[Gt + Vt + (s = _)], a = o[Gt + qt + s], h = o[Gt + 'dblclick' + s], o.removeEventListener(Vt, r, !!Ct && {passive: !1}), o.removeEventListener(qt, a, !!Ct && {passive: !1}), o.removeEventListener('dblclick', h, !1)) : 'removeEventListener' in t ? t.removeEventListener(Ei[i] || i, d, !1) : 'detachEvent' in t && t.detachEvent('on' + i, d), t[Ci][_] = null;
  }
  ...
  var qi = {
    ...
    options: {
      ...
      if ((i = void 0 === i ? this._zoom : this._limitZoom(i), t = this._limitCenter(j(t), i, this.options.maxBounds), e = e || {}, this._stop(), this._loaded && !e.reset && !0 !== e) && (void 0 !== e.animate && (e.zoom = h({animate: e.animate}, e.zoom), e.pan = h({
        animate: e.animate,
        duration: e.duration,
      ...
      var e = A(i.paddingTopLeft || i.padding || [0, 0]), n = A(i.paddingBottomRight || i.padding || [0, 0]),
      ...
      return this._moveStart(!0, t.noMoveStart), function t() {
        ...
        n <= 1 ? (this._flyToFrame = M(t, this), this._move(this.unproject(a.add(h.subtract(a).multiplyBy(f(o) / c)), u), this.getScaleZoom(l / (e = o, l * (p(m) / p(m + _ * e))), u), {flyTo: !0})) : this._move(s, r)._moveEnd(!0);
      }.call(this), this;
      ...
      var e, n, o = A((i = i || {}).paddingTopLeft || i.padding || [0, 0]),
        s = A(i.paddingBottomRight || i.padding || [0, 0]), r = this.getCenter(), a = this.project(r),
        h = this.project(t), u = this.getPixelBounds(), l = u.getSize().divideBy(2),
      ...
      var i, e = new D(t.coords.latitude, t.coords.longitude), n = e.toBounds(2 * t.coords.accuracy),
      ...
      var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(),
        a = t.getSouthEast(), h = this.getSize().subtract(e), u = O(this.project(a, n), this.project(r, n)).getSize(),
        l = vt ? this.options.zoomSnap : 1, c = h.x / u.x, _ = h.y / u.y, d = i ? Math.max(c, _) : Math.min(c, _),
      ...
      if (!e) return t;
      var n = this.project(t, i), o = this.getSize().divideBy(2), s = new I(n.subtract(o), n.add(o)),
      ...
      var n = O(this.project(i.getNorthEast(), e), this.project(i.getSouthWest(), e)), o = n.min.subtract(t.min),
  ...
  Ki.include({
    addControl: function (t) {
      ...
      var n = this._controlCorners = {}, o = 'leaflet-',
  ...
  Ki.mergeOptions({zoomControl: !0}), Ki.addInitHook(function () {
  ...
  Ki.mergeOptions({attributionControl: !0}), Ki.addInitHook(function () {
  ...
  var ee, ne = {Events: Z}, oe = bt ? 'touchstart mousedown' : 'mousedown',
  ...
  var fe = {
    simplify: he, pointToSegmentDistance: ue, closestPointOnSegment: function (t, i, e) {
      return de(t, i, e);
  ...
  var ve, ye = {clipPolygon: ge}, xe = {
    ...
    Le = h({}, F, {code: 'EPSG:3395', projection: we, transformation: G(ve = .5 / (Math.PI * we.R), .5, -ve, .5)}),
    be = h({}, F, {code: 'EPSG:4326', projection: xe, transformation: G(1 / 180, 1, -1 / 180, .5)}), Te = h({}, H, {
      projection: xe, transformation: G(1, 0, -1, 0), scale: function (t) {
        return Math.pow(2, t);
      }, zoom: function (t) {
  ...
  var Me = E.extend({
    options: {pane: 'overlayPane', attribution: null, bubblingMouseEvents: !0}, addTo: function (t) {
      ...
      e.hasLayer(this) && (this._map = e, this._zoomAnimated = e._zoomAnimated, this.getEvents && (i = this.getEvents(), e.on(i, this), this.once('remove', function () {
        e.off(i, this);
      }, this)), this.onAdd(e), this.getAttribution && e.attributionControl && e.attributionControl.addAttribution(this.getAttribution()), this.fire('add'), e.fire('layeradd', {layer: this}));
    },
  });
  Ki.include({
    addLayer: function (t) {
  ...
  var Ze = Se.extend({
    ...
    initialize: function (t) {
      ...
      var i, e = this._marker, n = e._map, o = this._marker.options.autoPanSpeed,
        s = this._marker.options.autoPanPadding, r = yi(e._icon), a = n.getPixelBounds(), h = n.getPixelOrigin(),
  ...
  var Re = Oe.extend({
    options: {fill: !0}, isEmpty: function () {
      ...
      var t = this._renderer._bounds, i = this.options.weight, e = new k(i, i),
  ...
  function De(t, i) {
    var e, n, o, s, r = 'Feature' === t.type ? t.geometry : t, a = r ? r.coordinates : null, h = [],
      u = i && i.pointToLayer, l = i && i.coordsToLatLng || We;
    if (!a && !r) return null;
    switch (r.type) {
      case'Point':
  ...
  Ki.mergeOptions({closePopupOnClick: !0}), Ki.include({
  ...
  var en = Qe.extend({
    options: {
      ...
      var i, e = this._map, n = this._container, o = e.latLngToContainerPoint(e.getCenter()),
        s = e.layerPointToContainerPoint(t), r = this.options.direction, a = n.offsetWidth, h = n.offsetHeight,
        u = A(this.options.offset), l = this._getAnchor(),
  ...
  var on = Me.extend({
    options: {
      ...
      if (i) {
        ...
        if (void 0 === t && (t = i.getCenter()), void 0 !== this._tileZoom) {
          var n = this._getTiledPixelBounds(t), o = this._pxBoundsToTileRange(n), s = o.getCenter(), r = [],
            a = this.options.keepBuffer, h = new I(o.getBottomLeft().subtract([a, -a]), o.getTopRight().add([a, -a]));
      ...
      var e = this._getTilePos(t), n = this._tileCoordsToKey(t),
  ...
  var sn = on.extend({
    options: {
      ...
      var i, e = {r: zt ? '@2x' : '', s: this._getSubdomain(t), x: t.x, y: t.y, z: this._getZoomForUrl()};
  ...
  var an = sn.extend({
    defaultWmsParams: {
      ...
      var i = this._tileCoordsToNwSe(t), e = this._crs, n = O(e.project(i[0]), e.project(i[1])), o = n.min, s = n.max,
  ...
  var hn = Me.extend({
    options: {padding: .1, tolerance: 0}, initialize: function (t) {
      ...
      var e = this._map.getZoomScale(i, this._zoom), n = yi(this._container),
  ...
  pn.create = dn, pn.pointsToPath = $, Ne.geometryToLayer = De, Ne.coordsToLatLng = We, Ne.coordsToLatLngs = He, Ne.latLngToCoords = Fe, Ne.latLngsToCoords = Ue, Ne.getFeature = Ve, Ne.asFeature = qe, Ki.mergeOptions({boxZoom: !0});
  var gn = ie.extend({
    initialize: function (t) {
      ...
      var i;
      1 !== t.which && 1 !== t.button || (this._finish(), this._moved && (this._clearDeferredResetState(), this._resetStateTimeout = setTimeout(p(this._resetState, this), 0), i = new R(this._map.containerPointToLatLng(this._startPoint), this._map.containerPointToLatLng(this._point)), this._map.fitBounds(i).fire('boxzoomend', {boxZoomBounds: i})));
  ...
  var yn = ie.extend({
    addHooks: function () {
      ...
      var t = this._worldWidth, i = Math.round(t / 2), e = this._initialWorldOffset, n = this._draggable._newPos.x,
        o = (n - i + e) % t + i - e, s = (n + i + e) % t - i - e, r = Math.abs(o + e) < Math.abs(s + e) ? o : s;
    ...
    addHooks: function () {
      ...
      if (t.touches && 2 === t.touches.length && this._zooming) {
        var i = this._map, e = i.mouseEventToContainerPoint(t.touches[0]),
          n = i.mouseEventToContainerPoint(t.touches[1]), o = e.distanceTo(n) / this._startDist;
