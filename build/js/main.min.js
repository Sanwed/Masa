...
var _nav = require("./modules/nav/nav.js");
var _initAccordion = require("./vendor/init-accordion.js");
var _sliders = require("./modules/sliders/sliders.js");
var _newsFilter = require("./modules/filter/news-filter.js");
var _customSelect = require("./modules/select/custom-select.js");
var _map = require("./modules/map/map.js");
// ---------------------------------
...
},{"./modules/filter/news-filter.js":2,"./modules/form-validate/form":4,"./modules/map/map.js":10,"./modules/modals/init-modals":11,"./modules/nav/nav.js":13,"./modules/select/custom-select.js":15,"./modules/sliders/sliders.js":17,"./utils/ios-vh-fix":20,"./vendor/init-accordion.js":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.filterNews = void 0;
var _sliders = require("../sliders/sliders.js");
var clearSlides = function clearSlides(container) {
  container.innerHTML = '';
};
var appendSlides = function appendSlides(container, arr) {
  arr.forEach(function (el) {
    container.append(el);
  });
};
var setActiveControl = function setActiveControl(controlsContainer, controlToSet) {
  Array.from(controlsContainer.children).forEach(function (control) {
    control.classList.remove('is-active');
  });
  controlToSet.classList.add('is-active');
};
var filterNews = function filterNews() {
  var slidesContainer = document.querySelector('.news__slider-wrapper');
  var controlsParent = document.querySelector('.news__controls');
  var slides = slidesContainer.querySelectorAll('.news__slide');
  controlsParent.addEventListener('click', function (evt) {
    if (evt.target.classList.contains('news__control')) {
      ...
      if (control.dataset.newsControl === 'common') {
        ...
        _sliders.newsSlider.update();
      } else {
        var filteredSlides = Array.from(slides).filter(function (slide) {
          return control.dataset.newsControl === slide.dataset.newsCard;
        });
        clearSlides(slidesContainer);
...
},{"../sliders/sliders.js":17}],3:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  lazyInit(mapElement, function () {
    ...
    var marker = new L.Marker([55.02858, 82.92804], {
      icon: markerIcon
    });
    marker.addTo(map);
  });
...
},{"../../utils/focus-lock":18,"../../utils/scroll-lock":21}],13:[function(require,module,exports){
"use strict";
...
var navBtn = document.querySelector('[data-nav="button"]');
var nav = document.querySelector('[data-nav="nav"]');
var navItems = nav.querySelectorAll('[data-nav="link"]');
...
var initNav = function initNav() {
  ...
  overlays.forEach(function (el) {
    el.addEventListener('click', function () {
      closeNav();
      _initAccordion.accordions.closeAllAccordion(nav);
    });
  });
...
},{"../../vendor/init-accordion.js":23}],14:[function(require,module,exports){
"use strict";
...
exports.newsSlider = exports.initSliders = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var newsSlider;
exports.newsSlider = newsSlider;
var initSliders = function initSliders() {
  var heroSlider = new _swiper.default('.hero__slider', {
  ...
  var programsSlider = new _swiper.default('.programs__slider', {
    loading: 'lazy',
  ...
  exports.newsSlider = newsSlider = new _swiper.default('.news__slider', {
    loading: 'lazy',
  ...
  var reviewsSlider = new _swiper.default('.reviews__slider', {
    loading: 'lazy',
...
},{"../../vendor/swiper.js":24}],18:[function(require,module,exports){
"use strict";
